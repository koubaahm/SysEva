 ...
 */
final class Version20240521104117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD publication_date VARCHAR(255) DEFAULT NULL, ADD journal_name VARCHAR(255) DEFAULT NULL');
